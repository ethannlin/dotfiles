...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting colored-man-pages z)
...
# >>> conda initialize >>>
# Only runs if miniconda is installed for the current user (portable; no dead PATH on machines without conda)
